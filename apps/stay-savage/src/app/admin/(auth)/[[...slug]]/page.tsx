...
function renderPage(slug?: string[]) {
  ...
  switch (page) {
    ...
    // --- Orders ---
    case 'orders':
      if (sub) return <OrderDetailPage orderId={sub} />;
      return <OrdersPage />;
    ...
    case 'returns':
      ...
      if (sub) return <ReturnDetailClient returnId={sub} />;
    ...
    // --- Products ---
    case 'products':
      if (sub === 'new') return <ProductFormClient productId={null} />;
      if (sub) return <ProductFormClient productId={sub} />;
    ...
    // --- Customers ---
    case 'customers':
      if (sub) return <CustomerDetailClient customerId={sub} />;
